package com.example.event_service.controllers.filter;

import com.example.event_service.controllers.util.JwtTokenUtil;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (null==webClientService.checkUser(header)) {
            chain.doFilter(request,response);
            return;
        }
